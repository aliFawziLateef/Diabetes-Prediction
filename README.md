...
The model is now trained using a proper train-test split (80% training, 20% testing) with stratification to maintain class distribution. This approach provides a more reliable evaluation of model performance compared to the previous version.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Ali-Fawzi/Diabetes-Prediction.git
